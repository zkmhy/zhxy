...
public class MyUtils {
	...
	public static String calendarTitle(int type, Date date) {
		...
		case 2:
			...
			String firstStr = !isYear ? simpleDateFormat.format(first) + " " +year
			: simpleDateFormat.format(first);
			String lastStr = !isTrue ? simpleDateFormat.format(last) : calendar.get(Calendar.DATE) + "";
			title = firstStr + " —— " + lastStr +" "+ calendar.get(Calendar.YEAR);
			break;
		case 3:
